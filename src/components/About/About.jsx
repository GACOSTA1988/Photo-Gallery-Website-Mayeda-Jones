      ...
      <div className="AboutHomeContainer">
        ...
        <div className="textContainer">
          ...
          <p className="aboutText">
            ...
            including the canadian rockies, dozens of national parks, and even
            the Arctic Circle in the dead of winter! <br />
            ...
            ones. <br />
            No matter how big, small or innovative your vision is, I would love
            to capture it in a timeless photograph!
          </p>
          <p id="headers">GEAR</p>
          <p className="aboutText">
